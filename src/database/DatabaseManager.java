...
public class DatabaseManager {
    ...
    private static final String DATABASE_URL_WITHOUT_SSH = "jdbc:oracle:thin:@dbhost.ugrad.cs.ubc.ca:1522:ug";

    private static DatabaseManager dbm;

    private static String username;
    private static String password;
    private static boolean ssh;
    ...
    public boolean startConnection(String username, String password, boolean ssh){
        DatabaseLoginInfoSetup(username, password, ssh);

        String database_url;
        if (ssh)
            database_url = DATABASE_URL_WITH_SSH;
        else
            database_url = DATABASE_URL_WITHOUT_SSH;
    ...
    private static void DatabaseLoginInfoSetup(String user, String pass, boolean sshEnabled) {
        username = user;
        password = pass;
        ssh = sshEnabled;
    }
